...
const ScrollToTopButton = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-20 md:bottom-13 right-6 w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center z-50 transition-opacity duration-300 ${
